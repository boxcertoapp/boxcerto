    ...
    <div className="bg-white border-2 border-indigo-100 rounded-3xl p-6 shadow-lg max-w-xl mx-auto">
      ...
      <div className="bg-red-50 border border-red-100 rounded-2xl p-4 mb-5 text-center">
        ...
        <p className="text-3xl font-extrabold text-red-600">
          R$ {perda.toLocaleString('pt-BR')}<span className="text-base">/mês</span>
        </p>
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl mx-auto items-start">
      ...
      <div className="space-y-3">
        ...
        {!aprovado && (
          <p className="text-center text-[11px] text-indigo-300 animate-pulse">
            👆 Clique em "Aprovar" para ver como funciona
          </p>
        )}
      </div>
    </div>
...
const COMPARATIVO = [
  ...
  ['Não sabe quanto lucrou no mês',             'Relatório financeiro em tempo real'],
  ...
  ['Ligando para cliente saber se o carro tá pronto', 'Cliente acompanha o status pelo link'],
]
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="px-4 pt-12 pb-16 text-center bg-gradient-to-b from-slate-900 to-indigo-950">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-slate-300 text-base leading-relaxed mb-4 max-w-lg mx-auto">
      ...
      {/* CALCULADORA */}
      <section className="bg-gray-50 px-4 pb-14">
      ...
      <section className="bg-slate-50 px-4 py-14">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <WppPrint avatarIdx={1} nome="Rafael S." tipo="Auto Elétrica" cidade="São Luís/MA"
              msg={"cara eu nunca soube de verdade quanto eu ganhava por mês. achava que era uns 6 mil líquido, quando fui ver no sistema era 4.200. fui caçar onde tava indo embora e descobri que tava perdendo em peça mesmo\n\nagora controlo tudo, mudou"}
              hora="16:47" resultado="Encontrou R$ 1.800/mês de perda em peças" />
            <WppPrint avatarIdx={2} nome="Ana Cristina P." tipo="Centro Automotivo" cidade="Goiânia/GO"
              msg={"meu marido achava que eu ia precisar de secretária pra dar conta da oficina. mostrei o sistema pra ele semana passada\n\ndesde março não preciso de ninguém pra controlar aprovação de cliente. tá tudo no link, pronto"}
            ...
            <WppPrint avatarIdx={3} nome="Leandro M." tipo="Estofaria Automotiva" cidade="Porto Alegre/RS"
              ...
              hora="11:08" resultado="Zerou disputas sobre preço aprovado" />
          </div>
        </div>
      </section>
