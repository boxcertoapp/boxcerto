/**
 * DemoLayout — idêntico ao AppLayout real, sem autenticação.
 * Oficina: Auto Center Machado (dados demo).
 * O contexto DemoModal permanece exportado para compatibilidade,
 * mas open() não bloqueia mais — as páginas funcionam livremente.
 */
...
// Contexto mantido para compat — open() não faz nada (demo livre)
      ...
      <div className="min-h-screen bg-gray-50 flex flex-col">
        ...
        <div className="hidden lg:flex min-h-screen">
          ...
          <aside className="w-56 bg-white border-r border-gray-100 flex flex-col fixed top-0 left-0 h-screen z-40">
            ...
            <div className="px-5 py-4 border-b border-gray-100">
              <div className="flex items-center gap-2.5">
                ...
                <div className="min-w-0">
                  <p className="text-[10px] text-slate-400 truncate">Auto Center Machado</p>
                </div>
              </div>
            </div>
            ...
            {/* CTA — idêntico ao banner de trial do app real */}
            <div
            ...
            >
              ...
              <span className="underline font-semibold">Criar minha conta →</span>
            </div>
          </aside>
        ...
        <div className="lg:hidden w-full max-w-lg mx-auto flex flex-col min-h-screen relative">
          ...
          {/* Header */}
          <header className="bg-white border-b border-gray-100 px-4 py-3 flex items-center justify-between sticky top-[33px] z-40 shrink-0">
            <Logo size="sm" priority />
            <span className="text-xs text-slate-400 truncate max-w-[150px]">Auto Center Machado</span>
          </header>
